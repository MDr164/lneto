...
| DHCPv6 | RFC 8415 | 🟡 | `dhcp/dhcpv6`, `x/xnet` | — | Client IA_NA/IA_PD, reconfigure-renew, relay frames/agent helpers, static IA_NA server, and xnet result assimilation; no dynamic server pools |
