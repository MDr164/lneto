...
| IPv6 Neighbor Discovery | RFC 4861 | 🟡 | `ipv6/icmpv6`, `x/xnet` | — | Neighbor solicitation/advertisement cache, RA fixed-header reports, and RA prefix option parsing; router state incomplete |
...
| IPv6 Path MTU Discovery | RFC 8201 | 🟡 | `ipv6/icmpv6` | — | Packet Too Big MTU reports recorded; route MTU selection not implemented |
| IPv6 Router Advertisement DNS Options | RFC 8106 | 🟡 | `ipv6/icmpv6`, `x/xnet` | — | RDNSS/DNSSL option parsing and explicit RDNSS assimilation; no passive router state |
