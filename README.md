...
| DHCPv6 | RFC 8415 | 🟡 | `dhcp/dhcpv6`, `x/xnet` | — | Client IA_NA address assignment, IA_PD prefix parsing, reconfigure-renew handling, and xnet result assimilation; no relay or server |
